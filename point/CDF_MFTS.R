...
point_fore_subnational_err_MFTS_F_K6_ETS    = point_fore_subnational_err_MFTS_M_K6_ETS    = array(NA, dim = c(47, 17, 4))
for(ij in 1:47)
{
    for(iw in 1:17)
    {
...
dimnames(point_fore_subnational_err_MFTS_F_EVR_ETS) = dimnames(point_fore_subnational_err_MFTS_M_EVR_ETS) =
dimnames(point_fore_subnational_err_MFTS_F_K6_ETS) = dimnames(point_fore_subnational_err_MFTS_M_K6_ETS) = list(state, 1:17, c("KLD", "JSD (geo)", "Wasserstein L1", "Wasserstein L2"))
...
rownames(horizon_point_fore_subnational_err_MFTS_F_EVR_ETS_mean) = rownames(horizon_point_fore_subnational_err_MFTS_F_K6_ETS_mean) = c(1:17, "Mean", "Median")
...
rownames(horizon_point_fore_subnational_err_MFTS_M_EVR_ETS_mean) = rownames(horizon_point_fore_subnational_err_MFTS_M_K6_ETS_mean) = c(1:17, "Mean", "Median")


saveRDS(point_fore_subnational_err_MFTS_F_EVR_ETS, file = paste0(dir.r, "point_fore_subnational_err_MFTS_F_EVR_ETS.rds"))
saveRDS(point_fore_subnational_err_MFTS_M_EVR_ETS, file = paste0(dir.r, "point_fore_subnational_err_MFTS_M_EVR_ETS.rds"))
saveRDS(point_fore_subnational_err_MFTS_F_K6_ETS, file = paste0(dir.r, "point_fore_subnational_err_MFTS_F_K6_ETS.rds"))
saveRDS(point_fore_subnational_err_MFTS_M_K6_ETS, file = paste0(dir.r, "point_fore_subnational_err_MFTS_M_K6_ETS.rds"))

saveRDS(point_fore_subnational_err_MFTS_F_EVR_ETS_mean, file = paste0(dir.r, "point_fore_subnational_err_MFTS_F_EVR_ETS_mean.rds"))
saveRDS(point_fore_subnational_err_MFTS_F_K6_ETS_mean, file = paste0(dir.r, "point_fore_subnational_err_MFTS_F_K6_ETS_mean.rds"))
saveRDS(point_fore_subnational_err_MFTS_M_EVR_ETS_mean, file = paste0(dir.r, "point_fore_subnational_err_MFTS_M_EVR_ETS_mean.rds"))
saveRDS(point_fore_subnational_err_MFTS_M_K6_ETS_mean, file = paste0(dir.r, "point_fore_subnational_err_MFTS_M_K6_ETS_mean.rds"))

saveRDS(horizon_point_fore_subnational_err_MFTS_F_EVR_ETS_mean, file = paste0(dir.r, "horizon_point_fore_subnational_err_MFTS_F_EVR_ETS_mean.rds"))
saveRDS(horizon_point_fore_subnational_err_MFTS_F_K6_ETS_mean, file = paste0(dir.r, "horizon_point_fore_subnational_err_MFTS_F_K6_ETS_mean.rds"))
saveRDS(horizon_point_fore_subnational_err_MFTS_M_EVR_ETS_mean, file = paste0(dir.r, "horizon_point_fore_subnational_err_MFTS_M_EVR_ETS_mean.rds"))
saveRDS(horizon_point_fore_subnational_err_MFTS_M_K6_ETS_mean, file = paste0(dir.r, "horizon_point_fore_subnational_err_MFTS_M_K6_ETS_mean.rds"))
...
point_fore_subnational_err_MFTS_F_EVR_ETS <- readRDS(paste0(dir.r, "point_fore_subnational_err_MFTS_F_EVR_ETS.rds"))
point_fore_subnational_err_MFTS_M_EVR_ETS <- readRDS(paste0(dir.r, "point_fore_subnational_err_MFTS_M_EVR_ETS.rds"))
point_fore_subnational_err_MFTS_F_K6_ETS <- readRDS(paste0(dir.r, "point_fore_subnational_err_MFTS_F_K6_ETS.rds"))
point_fore_subnational_err_MFTS_M_K6_ETS <- readRDS(paste0(dir.r, "point_fore_subnational_err_MFTS_M_K6_ETS.rds"))
