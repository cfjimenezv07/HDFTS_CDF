...
point_fore_subnational_err_MFTS_F_K6_ETS    = point_fore_subnational_err_MFTS_M_K6_ETS    = array(NA, dim = c(47, 16, 4))
for(ij in 1:47)
{
    for(iw in 1:16)
    {
...
dimnames(point_fore_subnational_err_MFTS_F_K6_ETS) = dimnames(point_fore_subnational_err_MFTS_M_K6_ETS) = list(state, 1:16, c("KLD", "JSD (geo)", "Wasserstein L1", "Wasserstein L2"))
...
rownames(horizon_point_fore_subnational_err_MFTS_F_EVR_ETS_mean) = rownames(horizon_point_fore_subnational_err_MFTS_F_K6_ETS_mean) = c(1:16, "Mean", "Median")
...
rownames(horizon_point_fore_subnational_err_MFTS_M_EVR_ETS_mean) = rownames(horizon_point_fore_subnational_err_MFTS_M_K6_ETS_mean) = c(1:16, "Mean", "Median")
