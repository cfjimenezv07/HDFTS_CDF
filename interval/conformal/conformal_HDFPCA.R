...
hdfpca_interval_fore_subnational_cdf_conformal <- function(fdata_F_data, fdata_M_data, fore_method, horizon, level_sig)
{
    ...
    if(fore_method == "CDF")
    {
      dum <- hdfpca_fun_fore(fdata_F = fdata_F_data[1:33,], fdata_M = fdata_M_data[1:33,],
    ...
    holdout_validation_F = t(matrix(fdata_F_data[(16 + horizon):33,], length((16 + horizon):33), ncol(fdata_F_data)))
    holdout_validation_M = t(matrix(fdata_M_data[(16 + horizon):33,], length((16 + horizon):33), ncol(fdata_M_data)))
    ...
    if(fore_method == "CDF")
    {
      ...
      dum <- hdfpca_fun_fore(fdata_F = fdata_F_data, fdata_M = fdata_M_data,
                          horizon = horizon, first_order = 6, second_order = 2, transformation = "CDF_test")
    ...
    holdout_val_F = t(matrix(fdata_F_data[(33 + horizon):49,], length((33 + horizon):49), ncol(fdata_F_data)))
    holdout_val_M = t(matrix(fdata_M_data[(33 + horizon):49,], length((33 + horizon):49), ncol(fdata_M_data)))
...
hdfpca_int_fore_subnational_err_F_EVR_conformal = hdfpca_int_fore_subnational_err_M_EVR_conformal = array(NA, dim = c(16, 3, 47))
for(ij in 1:47)
{
    for(iw in 1:16)
    {
...
rownames(hdfpca_int_fore_subnational_err_F_EVR_conformal_mean) = rownames(hdfpca_int_fore_subnational_err_M_EVR_conformal_mean) = 1:16
...
hdfpca_int_fore_subnational_err_M_EVR_conformal_alpha_0.95 = array(NA, dim = c(16, 3, 47))
for(ij in 1:47)
{
    for(iw in 1:16)
    {
...
rownames(hdfpca_int_fore_subnational_err_F_EVR_conformal_alpha_0.95_mean) = rownames(hdfpca_int_fore_subnational_err_M_EVR_conformal_alpha_0.95_mean) = 1:16
...
# Original 3D arrays
saveRDS(hdfpca_int_fore_subnational_err_F_EVR_conformal, 
        file = paste(dir.r, "hdfpca_int_fore_subnational_err_F_EVR_conformal.rds", sep="/"))
saveRDS(hdfpca_int_fore_subnational_err_M_EVR_conformal, 
        file = paste(dir.r, "hdfpca_int_fore_subnational_err_M_EVR_conformal.rds", sep="/"))

# 2D means of the above
saveRDS(hdfpca_int_fore_subnational_err_F_EVR_conformal_mean, 
        file = paste(dir.r, "hdfpca_int_fore_subnational_err_F_EVR_conformal_mean.rds", sep="/"))
saveRDS(hdfpca_int_fore_subnational_err_M_EVR_conformal_mean, 
        file = paste(dir.r, "hdfpca_int_fore_subnational_err_M_EVR_conformal_mean.rds", sep="/"))

# 3D arrays for alpha = 0.95
saveRDS(hdfpca_int_fore_subnational_err_F_EVR_conformal_alpha_0.95, 
        file = paste(dir.r, "hdfpca_int_fore_subnational_err_F_EVR_conformal_alpha_0.95.rds", sep="/"))
saveRDS(hdfpca_int_fore_subnational_err_M_EVR_conformal_alpha_0.95, 
        file = paste(dir.r, "hdfpca_int_fore_subnational_err_M_EVR_conformal_alpha_0.95.rds", sep="/"))

# 2D means for alpha = 0.95
saveRDS(hdfpca_int_fore_subnational_err_F_EVR_conformal_alpha_0.95_mean, 
        file = paste(dir.r, "hdfpca_int_fore_subnational_err_F_EVR_conformal_alpha_0.95_mean.rds", sep="/"))
saveRDS(hdfpca_int_fore_subnational_err_M_EVR_conformal_alpha_0.95_mean, 
        file = paste(dir.r, "hdfpca_int_fore_subnational_err_M_EVR_conformal_alpha_0.95_mean.rds", sep="/"))
