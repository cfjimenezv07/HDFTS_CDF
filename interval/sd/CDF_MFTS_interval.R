...
# ----------------------------
# SAVE ALL MFTS RESULTS
# ----------------------------

# EVR (level_sig = 0.8)
saveRDS(MFTS_int_fore_subnational_err_F_EVR_ETS, file = paste0(dir.r, "MFTS_int_fore_subnational_err_F_EVR_ETS.rds"))
saveRDS(MFTS_int_fore_subnational_err_M_EVR_ETS, file = paste0(dir.r, "MFTS_int_fore_subnational_err_M_EVR_ETS.rds"))
saveRDS(MFTS_int_fore_subnational_err_F_EVR_ETS_tune_para, file = paste0(dir.r, "MFTS_int_fore_subnational_err_F_EVR_ETS_tune_para.rds"))
saveRDS(MFTS_int_fore_subnational_err_M_EVR_ETS_tune_para, file = paste0(dir.r, "MFTS_int_fore_subnational_err_M_EVR_ETS_tune_para.rds"))
saveRDS(MFTS_int_fore_subnational_err_F_EVR_ETS_tune_para_obj, file = paste0(dir.r, "MFTS_int_fore_subnational_err_F_EVR_ETS_tune_para_obj.rds"))
saveRDS(MFTS_int_fore_subnational_err_M_EVR_ETS_tune_para_obj, file = paste0(dir.r, "MFTS_int_fore_subnational_err_M_EVR_ETS_tune_para_obj.rds"))
saveRDS(MFTS_int_fore_subnational_err_F_EVR_ETS_mean, file = paste0(dir.r, "MFTS_int_fore_subnational_err_F_EVR_ETS_mean.rds"))
saveRDS(MFTS_int_fore_subnational_err_M_EVR_ETS_mean, file = paste0(dir.r, "MFTS_int_fore_subnational_err_M_EVR_ETS_mean.rds"))

# K = 6 (level_sig = 0.8)
saveRDS(MFTS_int_fore_subnational_err_F_K6_ETS, file = paste0(dir.r, "MFTS_int_fore_subnational_err_F_K6_ETS.rds"))
saveRDS(MFTS_int_fore_subnational_err_M_K6_ETS, file = paste0(dir.r, "MFTS_int_fore_subnational_err_M_K6_ETS.rds"))
saveRDS(MFTS_int_fore_subnational_err_F_K6_ETS_tune_para, file = paste0(dir.r, "MFTS_int_fore_subnational_err_F_K6_ETS_tune_para.rds"))
saveRDS(MFTS_int_fore_subnational_err_M_K6_ETS_tune_para, file = paste0(dir.r, "MFTS_int_fore_subnational_err_M_K6_ETS_tune_para.rds"))
saveRDS(MFTS_int_fore_subnational_err_F_K6_ETS_tune_para_obj, file = paste0(dir.r, "MFTS_int_fore_subnational_err_F_K6_ETS_tune_para_obj.rds"))
saveRDS(MFTS_int_fore_subnational_err_M_K6_ETS_tune_para_obj, file = paste0(dir.r, "MFTS_int_fore_subnational_err_M_K6_ETS_tune_para_obj.rds"))
saveRDS(MFTS_int_fore_subnational_err_F_K6_ETS_mean, file = paste0(dir.r, "MFTS_int_fore_subnational_err_F_K6_ETS_mean.rds"))
saveRDS(MFTS_int_fore_subnational_err_M_K6_ETS_mean, file = paste0(dir.r, "MFTS_int_fore_subnational_err_M_K6_ETS_mean.rds"))

# EVR (level_sig = 0.95)
saveRDS(MFTS_int_fore_subnational_err_F_EVR_ETS_alpha_0.95, file = paste0(dir.r, "MFTS_int_fore_subnational_err_F_EVR_ETS_alpha_0.95.rds"))
saveRDS(MFTS_int_fore_subnational_err_M_EVR_ETS_alpha_0.95, file = paste0(dir.r, "MFTS_int_fore_subnational_err_M_EVR_ETS_alpha_0.95.rds"))
saveRDS(MFTS_int_fore_subnational_err_F_EVR_ETS_tune_para_alpha_0.95, file = paste0(dir.r, "MFTS_int_fore_subnational_err_F_EVR_ETS_tune_para_alpha_0.95.rds"))
saveRDS(MFTS_int_fore_subnational_err_M_EVR_ETS_tune_para_alpha_0.95, file = paste0(dir.r, "MFTS_int_fore_subnational_err_M_EVR_ETS_tune_para_alpha_0.95.rds"))
saveRDS(MFTS_int_fore_subnational_err_F_EVR_ETS_tune_para_obj_alpha_0.95, file = paste0(dir.r, "MFTS_int_fore_subnational_err_F_EVR_ETS_tune_para_obj_alpha_0.95.rds"))
saveRDS(MFTS_int_fore_subnational_err_M_EVR_ETS_tune_para_obj_alpha_0.95, file = paste0(dir.r, "MFTS_int_fore_subnational_err_M_EVR_ETS_tune_para_obj_alpha_0.95.rds"))
saveRDS(MFTS_int_fore_subnational_err_F_EVR_ETS_alpha_0.95_mean, file = paste0(dir.r, "MFTS_int_fore_subnational_err_F_EVR_ETS_alpha_0.95_mean.rds"))
saveRDS(MFTS_int_fore_subnational_err_M_EVR_ETS_alpha_0.95_mean, file = paste0(dir.r, "MFTS_int_fore_subnational_err_M_EVR_ETS_alpha_0.95_mean.rds"))

# K = 6 (level_sig = 0.95)
saveRDS(MFTS_int_fore_subnational_err_F_K6_ETS_alpha_0.95, file = paste0(dir.r, "MFTS_int_fore_subnational_err_F_K6_ETS_alpha_0.95.rds"))
saveRDS(MFTS_int_fore_subnational_err_M_K6_ETS_alpha_0.95, file = paste0(dir.r, "MFTS_int_fore_subnational_err_M_K6_ETS_alpha_0.95.rds"))
saveRDS(MFTS_int_fore_subnational_err_F_K6_ETS_tune_para_alpha_0.95, file = paste0(dir.r, "MFTS_int_fore_subnational_err_F_K6_ETS_tune_para_alpha_0.95.rds"))
saveRDS(MFTS_int_fore_subnational_err_M_K6_ETS_tune_para_alpha_0.95, file = paste0(dir.r, "MFTS_int_fore_subnational_err_M_K6_ETS_tune_para_alpha_0.95.rds"))
saveRDS(MFTS_int_fore_subnational_err_F_K6_ETS_tune_para_obj_alpha_0.95, file = paste0(dir.r, "MFTS_int_fore_subnational_err_F_K6_ETS_tune_para_obj_alpha_0.95.rds"))
saveRDS(MFTS_int_fore_subnational_err_M_K6_ETS_tune_para_obj_alpha_0.95, file = paste0(dir.r, "MFTS_int_fore_subnational_err_M_K6_ETS_tune_para_obj_alpha_0.95.rds"))
saveRDS(MFTS_int_fore_subnational_err_F_K6_ETS_alpha_0.95_mean, file = paste0(dir.r, "MFTS_int_fore_subnational_err_F_K6_ETS_alpha_0.95_mean.rds"))
saveRDS(MFTS_int_fore_subnational_err_M_K6_ETS_alpha_0.95_mean, file = paste0(dir.r, "MFTS_int_fore_subnational_err_M_K6_ETS_alpha_0.95_mean.rds"))



# EVR (level_sig = 0.8)
MFTS_int_fore_subnational_err_F_EVR_ETS <- readRDS(paste0(dir.r, "MFTS_int_fore_subnational_err_F_EVR_ETS.rds"))
MFTS_int_fore_subnational_err_M_EVR_ETS <- readRDS(paste0(dir.r, "MFTS_int_fore_subnational_err_M_EVR_ETS.rds"))

# K = 6 (level_sig = 0.8)
MFTS_int_fore_subnational_err_F_K6_ETS <- readRDS(paste0(dir.r, "MFTS_int_fore_subnational_err_F_K6_ETS.rds"))
MFTS_int_fore_subnational_err_M_K6_ETS <- readRDS(paste0(dir.r, "MFTS_int_fore_subnational_err_M_K6_ETS.rds"))

# EVR (level_sig = 0.95)
MFTS_int_fore_subnational_err_F_EVR_ETS_alpha_0.95 <- readRDS(paste0(dir.r, "MFTS_int_fore_subnational_err_F_EVR_ETS_alpha_0.95.rds"))
MFTS_int_fore_subnational_err_M_EVR_ETS_alpha_0.95 <- readRDS(paste0(dir.r, "int_fore_subnational_err_M_EVR_ETS_alpha_0.95.rds"))

# K = 6 (level_sig = 0.95)
MFTS_int_fore_subnational_err_F_K6_ETS_alpha_0.95 <- readRDS(paste0(dir.r, "MFTS_int_fore_subnational_err_F_K6_ETS_alpha_0.95.rds"))
MFTS_int_fore_subnational_err_M_K6_ETS_alpha_0.95 <- readRDS(paste0(dir.r, "MFTS_int_fore_subnational_err_M_K6_ETS_alpha_0.95.rds"))
