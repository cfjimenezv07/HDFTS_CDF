...
hdfpca_int_fore_subnational_err_F_EVR_ETS = hdfpca_int_fore_subnational_err_M_EVR_ETS = array(NA, dim = c(47, 16, 3), dimnames = list(state, 1:16, c("ECP", "CPD", "score")))
hdfpca_int_fore_subnational_err_F_EVR_ETS_tune_para = hdfpca_int_fore_subnational_err_F_EVR_ETS_tune_para_obj = 
hdfpca_int_fore_subnational_err_M_EVR_ETS_tune_para = hdfpca_int_fore_subnational_err_M_EVR_ETS_tune_para_obj = matrix(NA, 47, 16)
for(ij in 1:47)
{
    for(iw in 1:16)
    {
...
hdfpca_int_fore_subnational_err_F_EVR_ETS_alpha_0.95 = hdfpca_int_fore_subnational_err_M_EVR_ETS_alpha_0.95 = array(NA, dim = c(47, 16, 3), dimnames = list(state, 1:16, c("ECP", "CPD", "score")))
...
hdfpca_int_fore_subnational_err_M_EVR_ETS_tune_para_alpha_0.95 = hdfpca_int_fore_subnational_err_M_EVR_ETS_tune_para_obj_alpha_0.95 = matrix(NA, 47, 16)
for(ij in 1:47)
{
    for(iw in 1:16)
    {
...
# ----------------------------
# SAVE HDFPCA CDF RESULTS
# ----------------------------

# ----------------
# Level of significance = 0.8
# ----------------
saveRDS(hdfpca_int_fore_subnational_err_F_EVR_ETS, file = paste0(dir.r, "hdfpca_int_fore_subnational_err_F_EVR_ETS_CDF.rds"))
saveRDS(hdfpca_int_fore_subnational_err_M_EVR_ETS, file = paste0(dir.r, "hdfpca_int_fore_subnational_err_M_EVR_ETS_CDF.rds"))
saveRDS(hdfpca_int_fore_subnational_err_F_EVR_ETS_tune_para, file = paste0(dir.r, "hdfpca_int_fore_subnational_err_F_EVR_ETS_tune_para_CDF.rds"))
saveRDS(hdfpca_int_fore_subnational_err_M_EVR_ETS_tune_para, file = paste0(dir.r, "hdfpca_int_fore_subnational_err_M_EVR_ETS_tune_para_CDF.rds"))
saveRDS(hdfpca_int_fore_subnational_err_F_EVR_ETS_tune_para_obj, file = paste0(dir.r, "hdfpca_int_fore_subnational_err_F_EVR_ETS_tune_para_obj_CDF.rds"))
saveRDS(hdfpca_int_fore_subnational_err_M_EVR_ETS_tune_para_obj, file = paste0(dir.r, "hdfpca_int_fore_subnational_err_M_EVR_ETS_tune_para_obj_CDF.rds"))
saveRDS(horizon_specific_hdfpca_int_fore_subnational_err_F_EVR_ETS, file = paste0(dir.r, "horizon_specific_hdfpca_int_fore_subnational_err_F_EVR_ETS_CDF.rds"))
saveRDS(horizon_specific_hdfpca_int_fore_subnational_err_M_EVR_ETS, file = paste0(dir.r, "horizon_specific_hdfpca_int_fore_subnational_err_M_EVR_ETS_CDF.rds"))

# ----------------
# Level of significance = 0.95
# ----------------
saveRDS(hdfpca_int_fore_subnational_err_F_EVR_ETS_alpha_0.95, file = paste0(dir.r, "hdfpca_int_fore_subnational_err_F_EVR_ETS_alpha_0.95_CDF.rds"))
saveRDS(hdfpca_int_fore_subnational_err_M_EVR_ETS_alpha_0.95, file = paste0(dir.r, "hdfpca_int_fore_subnational_err_M_EVR_ETS_alpha_0.95_CDF.rds"))
saveRDS(hdfpca_int_fore_subnational_err_F_EVR_ETS_tune_para_alpha_0.95, file = paste0(dir.r, "hdfpca_int_fore_subnational_err_F_EVR_ETS_tune_para_alpha_0.95_CDF.rds"))
saveRDS(hdfpca_int_fore_subnational_err_M_EVR_ETS_tune_para_alpha_0.95, file = paste0(dir.r, "hdfpca_int_fore_subnational_err_M_EVR_ETS_tune_para_alpha_0.95_CDF.rds"))
saveRDS(hdfpca_int_fore_subnational_err_F_EVR_ETS_tune_para_obj_alpha_0.95, file = paste0(dir.r, "hdfpca_int_fore_subnational_err_F_EVR_ETS_tune_para_obj_alpha_0.95_CDF.rds"))
saveRDS(hdfpca_int_fore_subnational_err_M_EVR_ETS_tune_para_obj_alpha_0.95, file = paste0(dir.r, "hdfpca_int_fore_subnational_err_M_EVR_ETS_tune_para_obj_alpha_0.95_CDF.rds"))
saveRDS(horizon_specific_hdfpca_int_fore_subnational_err_F_EVR_ETS_alpha_0.95, file = paste0(dir.r, "horizon_specific_hdfpca_int_fore_subnational_err_F_EVR_ETS_alpha_0.95_CDF.rds"))
saveRDS(horizon_specific_hdfpca_int_fore_subnational_err_M_EVR_ETS_alpha_0.95, file = paste0(dir.r, "horizon_specific_hdfpca_int_fore_subnational_err_M_EVR_ETS_alpha_0.95_CDF.rds"))
...
dir.r <- "/Users/zdb518/Library/CloudStorage/GoogleDrive-cristian.jimenezvaron@york.ac.uk/My Drive/HDFTS_CDF/HDFTS_CDF/code_submission/Results_new/HLS/"

# ----------------
# Level of significance = 0.8
# ----------------
hdfpca_int_fore_subnational_err_F_EVR_ETS <- readRDS(paste0(dir.r, "hdfpca_int_fore_subnational_err_F_EVR_ETS_CDF.rds"))
hdfpca_int_fore_subnational_err_M_EVR_ETS <- readRDS(paste0(dir.r, "hdfpca_int_fore_subnational_err_M_EVR_ETS_CDF.rds"))
hdfpca_int_fore_subnational_err_F_K6_ETS <- readRDS(paste0(dir.r, "hdfpca_int_fore_subnational_err_F_EVR_ETS_CDF.rds"))
hdfpca_int_fore_subnational_err_M_K6_ETS <- readRDS(paste0(dir.r, "hdfpca_int_fore_subnational_err_M_EVR_ETS_CDF.rds"))

# ----------------
# Level of significance = 0.95
# ----------------
hdfpca_int_fore_subnational_err_F_EVR_ETS_alpha_0.95 <- readRDS(paste0(dir.r, "hdfpca_int_fore_subnational_err_F_EVR_ETS_alpha_0.95_CDF.rds"))
hdfpca_int_fore_subnational_err_M_EVR_ETS_alpha_0.95 <- readRDS(paste0(dir.r, "hdfpca_int_fore_subnational_err_M_EVR_ETS_alpha_0.95_CDF.rds"))
hdfpca_int_fore_subnational_err_F_K6_ETS_alpha_0.95 <- readRDS(paste0(dir.r, "hdfpca_int_fore_subnational_err_F_EVR_ETS_alpha_0.95_CDF.rds"))
hdfpca_int_fore_subnational_err_M_K6_ETS_alpha_0.95 <- readRDS(paste0(dir.r, "hdfpca_int_fore_subnational_err_M_EVR_ETS_alpha_0.95_CDF.rds"))

# Directory to save for Shiny app
dir.shiny2 <- "~/Library/CloudStorage/GoogleDrive-cristian.jimenezvaron@york.ac.uk/My Drive/HDFTS_CDF/HDFTS_CDF/code_submission/Shiny_App_CDF/datasets_shiny_app2/IFE/Japan/"

# List of arrays to process (already 47 × 16 × 3)
arrays_list <- list(
