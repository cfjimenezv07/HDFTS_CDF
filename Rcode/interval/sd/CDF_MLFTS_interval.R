...
MLFTS_int_fore_subnational_err_F_EVR_ETS = MLFTS_int_fore_subnational_err_M_EVR_ETS = array(NA, dim = c(16, 3, 47))
MLFTS_int_fore_subnational_err_F_EVR_ETS_tune_para = MLFTS_int_fore_subnational_err_F_EVR_ETS_tune_para_obj =
MLFTS_int_fore_subnational_err_M_EVR_ETS_tune_para = MLFTS_int_fore_subnational_err_M_EVR_ETS_tune_para_obj = matrix(NA, 16, 47)
for(ij in 1:47)
{
    for(iw in 1:16)
    {
...
rownames(MLFTS_int_fore_subnational_err_F_EVR_ETS_mean) = rownames(MLFTS_int_fore_subnational_err_M_EVR_ETS_mean) = 1:16

# K = 6

MLFTS_int_fore_subnational_err_F_K6_ETS = MLFTS_int_fore_subnational_err_M_K6_ETS = array(NA, dim = c(16, 3, 47))
MLFTS_int_fore_subnational_err_F_K6_ETS_tune_para = MLFTS_int_fore_subnational_err_F_K6_ETS_tune_para_obj =
MLFTS_int_fore_subnational_err_M_K6_ETS_tune_para = MLFTS_int_fore_subnational_err_M_K6_ETS_tune_para_obj = matrix(NA, 16, 47)
for(ij in 1:47)
{
    for(iw in 1:16)
    {
...
rownames(MLFTS_int_fore_subnational_err_F_K6_ETS_mean) = rownames(MLFTS_int_fore_subnational_err_M_K6_ETS_mean) = 1:16
...
MLFTS_int_fore_subnational_err_F_EVR_ETS_alpha_0.95 = MLFTS_int_fore_subnational_err_M_EVR_ETS_alpha_0.95 = array(NA, dim = c(16, 3, 47))
...
MLFTS_int_fore_subnational_err_M_EVR_ETS_tune_para_alpha_0.95 = MLFTS_int_fore_subnational_err_M_EVR_ETS_tune_para_obj_alpha_0.95 = matrix(NA, 16, 47)
for(ij in 1:47)
{
    for(iw in 1:16)
    {
...
rownames(MLFTS_int_fore_subnational_err_F_EVR_ETS_alpha_0.95_mean) = rownames(MLFTS_int_fore_subnational_err_M_EVR_ETS_alpha_0.95_mean) = 1:16

# K = 6

MLFTS_int_fore_subnational_err_F_K6_ETS_alpha_0.95 = MLFTS_int_fore_subnational_err_M_K6_ETS_alpha_0.95 = array(NA, dim = c(16, 3, 47))
...
MLFTS_int_fore_subnational_err_M_K6_ETS_tune_para_alpha_0.95 = MLFTS_int_fore_subnational_err_M_K6_ETS_tune_para_obj_alpha_0.95 = matrix(NA, 16, 47)
for(ij in 1:47)
{
    for(iw in 1:16)
    {
...
rownames(MLFTS_int_fore_subnational_err_F_K6_ETS_alpha_0.95_mean) = rownames(MLFTS_int_fore_subnational_err_M_K6_ETS_alpha_0.95_mean) = 1:16


# ----------------------------
# SAVE ALL MLFTS RESULTS
# ----------------------------

# EVR (level_sig = 0.8)
saveRDS(MLFTS_int_fore_subnational_err_F_EVR_ETS, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_F_EVR_ETS.rds"))
saveRDS(MLFTS_int_fore_subnational_err_M_EVR_ETS, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_M_EVR_ETS.rds"))
saveRDS(MLFTS_int_fore_subnational_err_F_EVR_ETS_tune_para, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_F_EVR_ETS_tune_para.rds"))
saveRDS(MLFTS_int_fore_subnational_err_M_EVR_ETS_tune_para, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_M_EVR_ETS_tune_para.rds"))
saveRDS(MLFTS_int_fore_subnational_err_F_EVR_ETS_tune_para_obj, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_F_EVR_ETS_tune_para_obj.rds"))
saveRDS(MLFTS_int_fore_subnational_err_M_EVR_ETS_tune_para_obj, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_M_EVR_ETS_tune_para_obj.rds"))
saveRDS(MLFTS_int_fore_subnational_err_F_EVR_ETS_mean, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_F_EVR_ETS_mean.rds"))
saveRDS(MLFTS_int_fore_subnational_err_M_EVR_ETS_mean, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_M_EVR_ETS_mean.rds"))

# K = 6 (level_sig = 0.8)
saveRDS(MLFTS_int_fore_subnational_err_F_K6_ETS, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_F_K6_ETS.rds"))
saveRDS(MLFTS_int_fore_subnational_err_M_K6_ETS, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_M_K6_ETS.rds"))
saveRDS(MLFTS_int_fore_subnational_err_F_K6_ETS_tune_para, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_F_K6_ETS_tune_para.rds"))
saveRDS(MLFTS_int_fore_subnational_err_M_K6_ETS_tune_para, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_M_K6_ETS_tune_para.rds"))
saveRDS(MLFTS_int_fore_subnational_err_F_K6_ETS_tune_para_obj, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_F_K6_ETS_tune_para_obj.rds"))
saveRDS(MLFTS_int_fore_subnational_err_M_K6_ETS_tune_para_obj, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_M_K6_ETS_tune_para_obj.rds"))
saveRDS(MLFTS_int_fore_subnational_err_F_K6_ETS_mean, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_F_K6_ETS_mean.rds"))
saveRDS(MLFTS_int_fore_subnational_err_M_K6_ETS_mean, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_M_K6_ETS_mean.rds"))

# EVR (level_sig = 0.95)
saveRDS(MLFTS_int_fore_subnational_err_F_EVR_ETS_alpha_0.95, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_F_EVR_ETS_alpha_0.95.rds"))
saveRDS(MLFTS_int_fore_subnational_err_M_EVR_ETS_alpha_0.95, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_M_EVR_ETS_alpha_0.95.rds"))
saveRDS(MLFTS_int_fore_subnational_err_F_EVR_ETS_tune_para_alpha_0.95, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_F_EVR_ETS_tune_para_alpha_0.95.rds"))
saveRDS(MLFTS_int_fore_subnational_err_M_EVR_ETS_tune_para_alpha_0.95, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_M_EVR_ETS_tune_para_alpha_0.95.rds"))
saveRDS(MLFTS_int_fore_subnational_err_F_EVR_ETS_tune_para_obj_alpha_0.95, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_F_EVR_ETS_tune_para_obj_alpha_0.95.rds"))
saveRDS(MLFTS_int_fore_subnational_err_M_EVR_ETS_tune_para_obj_alpha_0.95, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_M_EVR_ETS_tune_para_obj_alpha_0.95.rds"))
saveRDS(MLFTS_int_fore_subnational_err_F_EVR_ETS_alpha_0.95_mean, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_F_EVR_ETS_alpha_0.95_mean.rds"))
saveRDS(MLFTS_int_fore_subnational_err_M_EVR_ETS_alpha_0.95_mean, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_M_EVR_ETS_alpha_0.95_mean.rds"))

# K = 6 (level_sig = 0.95)
saveRDS(MLFTS_int_fore_subnational_err_F_K6_ETS_alpha_0.95, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_F_K6_ETS_alpha_0.95.rds"))
saveRDS(MLFTS_int_fore_subnational_err_M_K6_ETS_alpha_0.95, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_M_K6_ETS_alpha_0.95.rds"))
saveRDS(MLFTS_int_fore_subnational_err_F_K6_ETS_tune_para_alpha_0.95, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_F_K6_ETS_tune_para_alpha_0.95.rds"))
saveRDS(MLFTS_int_fore_subnational_err_M_K6_ETS_tune_para_alpha_0.95, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_M_K6_ETS_tune_para_alpha_0.95.rds"))
saveRDS(MLFTS_int_fore_subnational_err_F_K6_ETS_tune_para_obj_alpha_0.95, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_F_K6_ETS_tune_para_obj_alpha_0.95.rds"))
saveRDS(MLFTS_int_fore_subnational_err_M_K6_ETS_tune_para_obj_alpha_0.95, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_M_K6_ETS_tune_para_obj_alpha_0.95.rds"))
saveRDS(MLFTS_int_fore_subnational_err_F_K6_ETS_alpha_0.95_mean, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_F_K6_ETS_alpha_0.95_mean.rds"))
saveRDS(MLFTS_int_fore_subnational_err_M_K6_ETS_alpha_0.95_mean, file = paste0(dir.r, "MLFTS_int_fore_subnational_err_M_K6_ETS_alpha_0.95_mean.rds"))


# EVR (level_sig = 0.8)
MLFTS_int_fore_subnational_err_F_EVR_ETS <- readRDS(paste0(dir.r, "MLFTS_int_fore_subnational_err_F_EVR_ETS.rds"))
MLFTS_int_fore_subnational_err_M_EVR_ETS <- readRDS(paste0(dir.r, "MLFTS_int_fore_subnational_err_M_EVR_ETS.rds"))

# K = 6 (level_sig = 0.8)
MLFTS_int_fore_subnational_err_F_K6_ETS <- readRDS(paste0(dir.r, "MLFTS_int_fore_subnational_err_F_K6_ETS.rds"))
MLFTS_int_fore_subnational_err_M_K6_ETS <- readRDS(paste0(dir.r, "MLFTS_int_fore_subnational_err_M_K6_ETS.rds"))

# EVR (level_sig = 0.95)
MLFTS_int_fore_subnational_err_F_EVR_ETS_alpha_0.95 <- readRDS(paste0(dir.r, "MLFTS_int_fore_subnational_err_F_EVR_ETS_alpha_0.95.rds"))
MLFTS_int_fore_subnational_err_M_EVR_ETS_alpha_0.95 <- readRDS(paste0(dir.r, "int_fore_subnational_err_M_EVR_ETS_alpha_0.95.rds"))

# K = 6 (level_sig = 0.95)
MLFTS_int_fore_subnational_err_F_K6_ETS_alpha_0.95 <- readRDS(paste0(dir.r, "MLFTS_int_fore_subnational_err_F_K6_ETS_alpha_0.95.rds"))
MLFTS_int_fore_subnational_err_M_K6_ETS_alpha_0.95 <- readRDS(paste0(dir.r, "MLFTS_int_fore_subnational_err_M_K6_ETS_alpha_0.95.rds"))
...
arrays_list <- list(
  F_EVR_80      = MLFTS_int_fore_subnational_err_F_EVR_ETS,
  M_EVR_80      = MLFTS_int_fore_subnational_err_M_EVR_ETS,
  F_K6_80       = MLFTS_int_fore_subnational_err_F_K6_ETS,
  M_K6_80       = MLFTS_int_fore_subnational_err_M_K6_ETS,
  F_EVR_95      = MLFTS_int_fore_subnational_err_F_EVR_ETS_alpha_0.95,
  M_EVR_95      = MLFTS_int_fore_subnational_err_M_EVR_ETS_alpha_0.95,
  F_K6_95       = MLFTS_int_fore_subnational_err_F_K6_ETS_alpha_0.95,
  M_K6_95       = MLFTS_int_fore_subnational_err_M_K6_ETS_alpha_0.95
)
...
for(name in names(arrays_list)) {
  ...
  # Construct file name
  file_name <- paste0("MLFTS_", gender, "_", comp, "_", level, ".rds")
